...
#if 0    
    /**
     *   IIC0 GPIO INIT  PA9(SCL)&PA10(SDA)
     */
...
#else
    gpio_mode_set(MPU_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_PULLUP, MPU_CLK);
    gpio_output_options_set(MPU_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, MPU_CLK);    
