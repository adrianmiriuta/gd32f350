        ...
        void EvbLedControl2(int cmd)
{
            ...
            if (cmd == LED_ON)
            {
                gpio_bit_set(GPIOB, GPIO_PIN_9); /*点亮Led1灯*/
            }
            else
            {
                gpio_bit_reset(GPIOB, GPIO_PIN_9); /*熄灭Led1灯*/
            }
        }
        ...
        void EvbLedControl3(int cmd)
{
            ...
            if (cmd == LED_ON)
            {
                gpio_bit_set(GPIOB, GPIO_PIN_10); /*点亮Led1灯*/
            }
            else
            {
                gpio_bit_reset(GPIOB, GPIO_PIN_10); /*熄灭Led1灯*/
            }
        }
/*************************************************************************************************
 *  功能：控制Led的点亮和熄灭                                                                    *
